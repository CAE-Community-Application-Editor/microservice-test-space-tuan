...
/**
 *
 * test-space-tuan - Test Class
 *
 * This class provides a basic testing framework for the microservice test-space-tuan. It was
 * generated by the CAE (Community Application Framework).
 *
 */
public class tuan-resourceTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(tuan-resource.class.getCanonicalName(),"0.1");
